...
// Стандартные адреса EntryPoint
export const ENTRY_POINT_V06 = "0x5FF137D4b0FDCD49dcae6b3cD1eE8fB1f1A5aC00";
export const ENTRY_POINT_V07 = "0x0000000071727De22E5E9d8BAf0edAc6f37da032"; // <-- используем его
...
export const monadTestnet = defineChain({
  ...
  // Подсказка для AA-клиентов: сразу ставим версию 0.7
  accountAbstraction: {
