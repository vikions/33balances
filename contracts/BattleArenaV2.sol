...
/// @title Battle Arena V2
/// @notice Paid match entry tracking with win/loss stats and streak-based NFT rewards.
contract BattleArenaV2 is ERC721, Ownable {
    ...
    string public constant PLACEHOLDER_TOKEN_URI =
        "https://example.com/battle-arena-v2/metadata.json";
    ...
    constructor() ERC721("Battle Arena Streak Reward", "BASR") Ownable(msg.sender) {}
